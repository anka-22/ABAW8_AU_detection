...
if __name__ == '__main__':
    ...
    # 1.2. Paths
    parser.add_argument('-dataset_path', default='/home/data/Affwild2_processed', type=str,
                        help='The root directory of the preprocessed dataset.') 
    parser.add_argument('-load_path', default='/home/data/load', type=str,
                        help='The path to load the trained models, such as the backbone.') 
    parser.add_argument('-save_path', default='/home/data/ABAW6_test_video/save', type=str,
                        help='The path to save the trained models ')  
    parser.add_argument('-python_package_path', default='/home/data/ABAW6_test_video', type=str,
